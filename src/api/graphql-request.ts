...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    allFilms(variables?: AllFilmsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AllFilmsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<AllFilmsQuery>(AllFilmsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'allFilms', 'query');
    }
  };
}
